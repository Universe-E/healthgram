...
public class Database {
    ...
    public static class Post {
        ...
        public static void savePostData(String authorId, String content, Object... args) {
            ...
            long utcTime = Calendar.getInstance().getTimeInMillis();

            Map<String, Object> post = new HashMap<>();
            post.put("authorId", authorId);
            post.put("content", content);
            post.put("create time", utcTime);
        ...
        public static void getPostsByDateTime(long datetime, int limit, Object object, String methodName, Object... args) {
        ...
        public static void getUserPost(long utcTime, int limit, Object object, String methodName, Object... args) {
            String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();

            getPostsByAuthorId(utcTime, limit, userId, object, methodName, args);
        }

        //Get a list of posts by author id
        public static void getPostsByAuthorId(long utcTime, int limit,String authorId, Object object, String methodName, Object... args) {
            FirebaseFirestore.getInstance().collection("posts")
                    .whereEqualTo("authorId", authorId)
                    .orderBy("dateTime", Query.Direction.DESCENDING)
                    .whereLessThan("dateTime", utcTime)
                    .limit(limit).get()
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            List<DocumentSnapshot> documents = task.getResult().getDocuments();
